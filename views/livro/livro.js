    ...
    postForm(`${BASEURL}/livro/loadData/${numero}`)
        .then(resp => {
            if (resp.data.length > 0) {
                ...
                txtcodlivro.value = resp.data[0].codigo;
                txtisbn.value = resp.data[0].isbn;
                txttitlivro.value = resp.data[0].titulo;
                txtedlivro.value = resp.data[0].edicao;
                txtvallivro.value = resp.data[0].valor;
